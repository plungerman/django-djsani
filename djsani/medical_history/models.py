...
class StudentMedicalHistory(models.Model):
    ...
    epi_pen = models.TextField(null=True)
    pots = models.TextField(null=True)
    sickle_cell = models.TextField(null=True)
    other_heart_condition = models.TextField(null=True)
    long_covid = models.TextField(null=True)
    other_respiratory= models.TextField(null=True)
    smoke_vape = models.TextField(null=True)
    ibs = models.TextField(null=True)
    gerd = models.TextField(null=True)
    other_digestive = models.TextField(null=True)
    kidney_disease = models.TextField(null=True)
    kidney_stones = models.TextField(null=True)
    ...
    lupus = models.TextField(null=True)
    other_autoimmune = models.TextField(null=True)
